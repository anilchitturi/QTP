...
x = DataTable.Value("Procurement","cordinates")
x1 = DataTable.Value("OpenPO","cordinates")
DataTable.SetCurrentRow(2)
y = DataTable.Value("Procurement","cordinates")
y1 = DataTable.Value("OpenPO","cordinates")

VbWindow(login_form1).ActiveX(actx).ActiveX(actx1).Click x,y
